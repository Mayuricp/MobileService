...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { address: @seller.address, first_name: @seller.first_name, last_name: @seller.last_name, middle_name: @seller.middle_name, mobile_number: @seller.mobile_number } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { address: @seller.address, first_name: @seller.first_name, last_name: @seller.last_name, middle_name: @seller.middle_name, mobile_number: @seller.mobile_number } }
